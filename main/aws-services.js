...
async function generatePrompt(trigger, context) {
  ...
  const systemPrompt = `You are a concise coach for a live cam performer. Given the trigger "${trigger}" and session stats, give ONE actionable tip in 1-2 sentences. Be specific, motivating, and brief.`;
